...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //  Active to inactive state ( phone call, home-list of app, home ( then background )
    ...
    // Inactive to background ( 30s plus ou moins pour du code
