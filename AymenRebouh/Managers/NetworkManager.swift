...
private let kPublicKey = "AIzaSyCO_HPYCsvBm2Qwvszsa6pW7qjiDZ5Cwho"
...
final class NetworkManager {
  ...
  */
  func authenticateUserWithEmail(email: String, password: String, completionHandler: JSONResponseClosure) {
    request(.POST, "http://www.aymenworks.fr/beacon/authenticateUser", parameters:["email": email, "password": password])
      .validate()
      .responseSwiftyJSON({ (request, httpRequest, jsonResponse, error) in
  ...
  */
  func signUpUserWithPassword(email: String, password: String, lastName: String, firstName: String,
    formation: String, schoolId: String, completionHandler: JSONResponseClosure) {
      ...
      */
      func googlePlusProfileWithUserId(userId: String, completionHandler: (firstName: String?, lastName: String?,
        profilPicture: UIImage?, error: NSError?) -> Void) {
          ...
          request(.GET, "https://www.googleapis.com/plus/v1/people/\(userId)?fields=image,name&key=\(kPublicKey)")
            .validate()
            .responseSwiftyJSON({ (_, _, jsonResponse, error) in
  ...
  */
  ...
  :param: completionHandler The callback that'll be executed after the request has finished
  */
  func fetchUserProfile(email: String, completionHandler: JSONResponseClosure) {
  ...
  */
  func roomsBySchoolId(schoolId: String, completionHandler: JSONResponseClosure) {
  ...
  */
  ...
  :param: completionHandler <#completionHandler description#>
  */
  func addMyPresenceInRoom(roomId: Int, userEmail: String, completionHandler: JSONResponseClosure) {
  ...
  :param: completionHandler <#completionHandler description#>
  */
  func deleteMyPresenceFromRoomWithEmail(userEmail: String, completionHandler: (JSONResponseClosure)? = nil) {
