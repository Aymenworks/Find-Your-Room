...
public final class Facade {
  ...
  */
  ...
  /**
  Add a room in the database with the associated beacon.
  ...
  */
  ...
  /**
  Add the presence of the current user on the room he entered.
  
  :param: roomId            The room identifier
  :param: userEmail         The encoded base64 user email
  :param: completionHandler The callback containing the json server/error response that'll be executed
  after the request has finished
  */
  ...
  /**
  Delete the presence of the current user on the room he left.
