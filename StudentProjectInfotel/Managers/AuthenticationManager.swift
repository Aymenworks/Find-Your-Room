...
class AuthenticationManager {
    ...
    */
    func authenticateUserWithFacebookOrGooglePlus(email: String, lastName: String, firstName: String, completionHandler: (JSON?, NSError?) -> Void) {
        request(.POST, "http://www.aymenworks.fr/beacon/authenticateUserWithFacebookOrGooglePlus", parameters:["email": email, "lastName": lastName, "firstName": firstName])
            .validate()
    ...
    */
    func googlePlusProfile(userId: String, completionHandler: (firstName: String?, lastName: String?, profilPicture: UIImage?, error: NSError?) -> Void) {
        ...
        */
        ...
        :param: completionHandler The callback containing the user first name, last name, profile picture, that'll be executed after the request has finished
        */
        func googlePlusProfileWithUserId(userId: String, completionHandler: (firstName: String?, lastName: String?, profilPicture: UIImage?, error: NSError?) -> Void) {
